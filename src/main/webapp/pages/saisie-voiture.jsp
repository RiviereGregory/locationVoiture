...
<title><spring:message code="saisie-voiture.titre.fenetre" /></title>
</head>
<body>
	<!-- HEADER -->
<%-- 	<%@ include file="/pages/header.jsp"%> --%>
	...
	<c:if test="${empty voiture.id}">
		<h1 align="center">
			<spring:message code="saisie-voiture.titre" />
		</h1>
		<br />
	</c:if>
	...
	<form:form action="voitures.do" commandName="voiture" method="POST">
		...
		<table align="center">
			...
			<tr>
				<td><spring:message code="voiture.marque" /> :</td>
				<td><form:input path="marque" /> <form:errors path="marque" /></td>
			</tr>
			<tr>
				<td><spring:message code="voiture.modele" /> :</td>
				<td><form:input path="modele" /> <form:errors path="modele" /></td>
			</tr>
			<tr>
				<td><spring:message code="voiture.date" /> :</td>
